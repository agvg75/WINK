...
def before_you_film(doc):
    ...
    add_matrix(doc, ["Module or biological question", "Film to make this easy", "Known hard cases / plan extra review"], [
        ...
        ("Population swimming and modality review",
...
def front_matter(doc):
    ...
    add_matrix(doc, ["Question", "Start with", "Do not substitute"], [
        ...
        ("Many worms swimming/crawling/burrowing", "Population swimming + modality review", "One frequency threshold alone"),
...
def locomotion(doc):
    ...
    tool(doc, "Population swimming + modality review", "Experimental",
