...
class App(CockpitApp):
    ...
    def _show_schematic(self):
        """Open the reference body-wall numbering schematic in the system's
        default image viewer - a separate reference window, same as the
        macro's own showSchematic(), so a student can check which numbered
        myocyte (Myo01-24) they're looking at against the working image."""
        path = None
