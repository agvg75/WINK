...
REGISTRY = [
    ...
    Tool("Population swimming + modality review", "Track populations, optionally include/exclude drawn ROIs, and visually review proposed swimming, crawling, burrowing, and uncertain bouts.",
    ...
    Tool("Evoked mechanosensation + habituation (Experimental)",
    ...
    Tool("Sample planner - how many more? (Experimental)",
    ...
    Tool("Single-channel GCaMP feasibility + extractor (Experimental)",
         "Validate first and sample only feasibility frames; load the full recording only after a pass and an explicit extraction request.",
         "Physiology - Calcium and cellular activity", "python", "ready",
         "tools/single_channel_gcamp/gcamp_tool.py",
         requires="declared FPS, scale, exposure, bit depth, and channel; visible target on sampled frames; reviewed low-signal intervals"),
